...
const CargarDocumentoOS3 = ({
	...
	useEffect(() => {
		...
		} else if (tercerObligadoSolidario === "PFAE" || tercerObligadoSolidario === "PF") {
			var config = {
				method: 'get',
						...
						<Fragment key={i}>
							...
							<div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
								<div className="border-gray-2" style={{ display: 'flex', width: '70%', padding: '4px' }}>
									{
										fileFour[i] !== undefined &&
										<>
											<img src={fileFour[i][0]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileFour[i][1]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileFour[i][2]} style={{ height: '50px', marginRight: '4px' }} />
										</>
									}
...
export default CargarDocumentoOS3;