...
const CargarDocumentoOS5 = ({
	...
	useEffect(() => {
		...
		} else if (quintoObligadoSolidario === "PFAE" || quintoObligadoSolidario === "PF") {
			var config = {
				method: 'get',
								...
								<div className="border-gray-2" style={{ display: 'flex', width: '70%', padding: '4px' }}>
									{
										fileSix[i] !== undefined &&
										<>
											<img src={fileSix[i][0]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileSix[i][1]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileSix[i][2]} style={{ height: '50px', marginRight: '4px' }} />
										</>
									}
...
export default CargarDocumentoOS5;