...
const CargarDocumentoSolicitante = ({
	setFileOne,
	fileOne,
	setShowResult,
	tipoPersona,
								...
								<div className="border-gray-2" style={{ display: 'flex', width: '70%', padding: '4px' }}>
									{
										fileOne[i] !== undefined &&
										<>
											<img src={fileOne[i][0]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileOne[i][1]} style={{ height: '50px', marginRight: '4px' }} />
											<img src={fileOne[i][2]} style={{ height: '50px', marginRight: '4px' }} />
										</>
									}
...
export default CargarDocumentoSolicitante;