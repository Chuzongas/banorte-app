...
const Navbar = ({ phone = true }) => {
	...
	const navBarTransition = useTransition(showNavbar, {
		from: { opacity: '0', position: 'absolute', zIndex: '1000', width: '100%', top: '0px' },
		enter: { opacity: '1', position: 'absolute', zIndex: '1000', width: '100%', top: '0px' },
		leave: { opacity: '0', position: 'absolute', zIndex: '1000', width: '100%', top: '0px' }
	})
		...
		<>
			{
				window.innerWidth <= 991 ?
					<>
						<div className="my-navbar bgc-red" style={{ display: 'flex', justifyContent: "space-between", alignItems: 'center', position: 'fixed', zIndex: '1000', top: '0px' }}>
							...
							<i onClick={() => setShowNavbar(!showNavbar)} className="ri-menu-line pointer" style={{ fontSize: '44px', marginRight: '12px' }}></i>
							{
								navBarTransition((style, visible) =>
									...
									<animated.div style={style}>
										<div className='bgc-red' style={{ position: 'absolute', top: '70px', zIndex: '1000', width: '100%', padding: '24px 0px' }}>
											...
											<div style={{ display: 'flex', flexFlow: 'column', alignItems: 'center' }}>
												<span onClick={() => setShowNavbar(false)} className='pointer' style={{ marginBottom: '22px', fontSize: '24px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#simula">SIMULA TU CRÉDITO</a></span>
												<span onClick={() => window.location.href = "/formulario"} className='pointer' style={{ marginBottom: '22px', fontSize: '24px' }}>PYMES</span>
												<span onClick={() => setShowNavbar(false)} className='pointer' style={{ marginBottom: '22px', fontSize: '24px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#planes">PLANES</a></span>
												<span onClick={() => setShowNavbar(false)} className='pointer' style={{ marginBottom: '22px', fontSize: '24px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#pasos">PASOS</a></span>
												<span onClick={() => setShowNavbar(false)} className='pointer' style={{ fontSize: '24px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#faq">FAQ</a></span>
											</div>
										</div>
									</animated.div>
								)
						...
						<div style={{ height: '70px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '972px', margin: '0px auto' }}>
							...
							<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
								<div style={{ marginRight: '16px' }}>
									<span className='pointer' style={{ margin: '4px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#simula">SIMULA TU CRÉDITO</a></span>
									<span onClick={() => window.location.href = "/formulario"} className='pointer' style={{ margin: '4px' }}>PYMES</span>
									<span className='pointer' style={{ margin: '4px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#planes">PLANES</a></span>
									<span className='pointer' style={{ margin: '4px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#pasos">PASOS</a></span>
									<span className='pointer' style={{ margin: '4px' }}><a style={{textDecoration:'none', color:'white'}} href="/home#faq">FAQ</a></span>
								</div>
